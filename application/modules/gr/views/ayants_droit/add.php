	...
	<div class="content-wrapper" style="min-height: 357.039px;">
     <section class="content">
		...
		<div class="row">			
			...
			<div class='col-md-3'><label>Ref. Extrait de naissance</label>
			<?=form_input('ref_extrait_naissance',set_value('ref_extrait_naissance'),"class='form-control' placeholder='ref_extrait_naissance'")?>
						<?php echo form_error('ref_extrait_naissance','<div class="text-danger">', '</div>'); ?></div>
			...
			<div class='col-md-3'><label>Prise en charge</label>
